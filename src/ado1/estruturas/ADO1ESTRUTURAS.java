        ...
        while(opt == 1){
            ...
            switch(escolha){
                case 1: Carros ca = new Carros();
                    ...
                    break;
                case 2: Carros car = new Carros();
                        System.out.println("*****Inserir no fim da lista*****");
                        System.out.println("Insira o modelo: ");
                        ...
                        System.out.println("**************Carro inserido**************");
                    break;
                case 3: System.out.println("*****Pesquisar carro por modelo*****");
                        System.out.println("Insira o modelo: ");
                        String modelo_p = c.next();
                        System.out.println(lis.pesquisarNo(modelo_p));
                        System.out.println("*****Pesquisa concluída*****");
                    break;                
                case 4:System.out.println("*****Imprimir toda a lista*****");
                       System.out.println(lis.imprimirLista());
                       System.out.println("*****Fim da Lista*****");
                    break;
                case 5:System.out.println("*****Remover um elemento da lista*****");
                       System.out.println("Insira o modelo: ");
